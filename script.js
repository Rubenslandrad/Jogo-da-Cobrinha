...
let direction = "right";
let food = {
    x: Math.floor(Math.random() * 15 + 1) * box, //math.random numero aleatorio
...
document.addEventListener('keydown', update);//keydow evento de click e vai chamar a funçao update
